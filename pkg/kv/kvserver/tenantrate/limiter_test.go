...
func (ts *testState) HasCrossTenantRead(ctx context.Context, tenID roachpb.TenantID, key roachpb.RKey) bool {
	return false
}
...
func (fakeAuthorizer) HasCrossTenantRead(ctx context.Context, tenID roachpb.TenantID, key roachpb.RKey) bool {
	return false
}
