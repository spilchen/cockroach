...
var cockroachdbMetrics = map[string]string{
    ...
    "jobs_partition_ttl_cleanup_currently_idle": "jobs.partition_ttl_cleanup.currently_idle",
    "jobs_partition_ttl_cleanup_currently_paused": "jobs.partition_ttl_cleanup.currently_paused",
    "jobs_partition_ttl_cleanup_currently_running": "jobs.partition_ttl_cleanup.currently_running",
    "jobs_partition_ttl_cleanup_expired_pts_records": "jobs.partition_ttl_cleanup.expired_pts_records",
    "jobs_partition_ttl_cleanup_fail_or_cancel_completed": "jobs.partition_ttl_cleanup.fail_or_cancel_completed",
    "jobs_partition_ttl_cleanup_fail_or_cancel_retry_error": "jobs.partition_ttl_cleanup.fail_or_cancel_retry_error",
    "jobs_partition_ttl_cleanup_protected_age_sec": "jobs.partition_ttl_cleanup.protected_age_sec",
    "jobs_partition_ttl_cleanup_protected_record_count": "jobs.partition_ttl_cleanup.protected_record_count",
    "jobs_partition_ttl_cleanup_resume_completed": "jobs.partition_ttl_cleanup.resume_completed",
    "jobs_partition_ttl_cleanup_resume_failed": "jobs.partition_ttl_cleanup.resume_failed",
    "jobs_partition_ttl_cleanup_resume_retry_error": "jobs.partition_ttl_cleanup.resume_retry_error",
    "jobs_partition_ttl_scheduler_currently_idle": "jobs.partition_ttl_scheduler.currently_idle",
    "jobs_partition_ttl_scheduler_currently_paused": "jobs.partition_ttl_scheduler.currently_paused",
    "jobs_partition_ttl_scheduler_currently_running": "jobs.partition_ttl_scheduler.currently_running",
    "jobs_partition_ttl_scheduler_expired_pts_records": "jobs.partition_ttl_scheduler.expired_pts_records",
    "jobs_partition_ttl_scheduler_fail_or_cancel_completed": "jobs.partition_ttl_scheduler.fail_or_cancel_completed",
    "jobs_partition_ttl_scheduler_fail_or_cancel_retry_error": "jobs.partition_ttl_scheduler.fail_or_cancel_retry_error",
    "jobs_partition_ttl_scheduler_protected_age_sec": "jobs.partition_ttl_scheduler.protected_age_sec",
    "jobs_partition_ttl_scheduler_protected_record_count": "jobs.partition_ttl_scheduler.protected_record_count",
    "jobs_partition_ttl_scheduler_resume_completed": "jobs.partition_ttl_scheduler.resume_completed",
    "jobs_partition_ttl_scheduler_resume_failed": "jobs.partition_ttl_scheduler.resume_failed",
    "jobs_partition_ttl_scheduler_resume_retry_error": "jobs.partition_ttl_scheduler.resume_retry_error",
