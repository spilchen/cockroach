...
var cockroachdbMetrics = map[string]string{
    ...
    "jobs_partition_ttl_maintenance_currently_idle": "jobs.partition_ttl_maintenance.currently_idle",
    "jobs_partition_ttl_maintenance_currently_paused": "jobs.partition_ttl_maintenance.currently_paused",
    "jobs_partition_ttl_maintenance_currently_running": "jobs.partition_ttl_maintenance.currently_running",
    "jobs_partition_ttl_maintenance_expired_pts_records": "jobs.partition_ttl_maintenance.expired_pts_records",
    "jobs_partition_ttl_maintenance_fail_or_cancel_completed": "jobs.partition_ttl_maintenance.fail_or_cancel_completed",
    "jobs_partition_ttl_maintenance_fail_or_cancel_retry_error": "jobs.partition_ttl_maintenance.fail_or_cancel_retry_error",
    "jobs_partition_ttl_maintenance_protected_age_sec": "jobs.partition_ttl_maintenance.protected_age_sec",
    "jobs_partition_ttl_maintenance_protected_record_count": "jobs.partition_ttl_maintenance.protected_record_count",
    "jobs_partition_ttl_maintenance_resume_completed": "jobs.partition_ttl_maintenance.resume_completed",
    "jobs_partition_ttl_maintenance_resume_failed": "jobs.partition_ttl_maintenance.resume_failed",
    "jobs_partition_ttl_maintenance_resume_retry_error": "jobs.partition_ttl_maintenance.resume_retry_error",
