...
var cockroachdbMetrics = map[string]string{
	...
	"kv_rangefeed_closed_timestamp_max_behind_nanos":                               "kv.rangefeed.closed_timestamp.max_behind_nanos",
	"kv_rangefeed_output_loop_unbuffered_registration_nanos":                       "kv.rangefeed.output_loop.unbuffered_registration_nanos",
