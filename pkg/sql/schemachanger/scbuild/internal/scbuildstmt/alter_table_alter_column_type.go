...
func handleGeneralColumnConversion(
	...
	// Changing the type of a virtual column should always be treated as a
	// virtual or validation conversion, as there's never a need to rewrite
	// the column. Since virtual columns store no data, no physical changes
	// are required.
