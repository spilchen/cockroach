...
// NewPlanPoliciesFactory builds and returns a PlanPoliciesFactory struct
func NewPlanPoliciesFactory(md *opt.Metadata) PlanPoliciesFactory {
	return PlanPoliciesFactory{md: md}
}
