...
type Metadata struct {
	...
	// rlsMeta store the metadata associated with row-level security policies that
	// were enforced in this query.
...
func (md *Metadata) CheckDependencies(
	...
	// Check for staleness from an row-level security point of view.
