...
// TestMergePhaseUniquenessEnforcement verifies that duplicate keys are detected
// during the merge phase when EnforceUniqueness is enabled.
func TestMergePhaseUniquenessEnforcement(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
