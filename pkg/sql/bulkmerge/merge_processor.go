...
func (m *bulkMergeProcessor) ingestFinalIteration(
	...
	// disallowShadowingBelow to the write timestamp. This causes SSTBatcher to
	// detect duplicate keys both within batches (DuplicateKeyError) and across
	// batches during SST ingestion (KeyCollisionError).
