...
type MergeOptions struct {
	...
	// EnforceUniqueness enables duplicate key checking during the final merge.
	// Should be true when building unique indexes. Duplicate key errors
	// propagate as DuplicateKeyError or KeyCollisionError. Callers are
	// responsible for wrapping these into user friendly messages.
